...
import { bookmarkUnbookmarkPost, commentonPost, createPost, deletePost, getAllPosts, getBookmarkedPosts, getFollowingPosts, getLikedPosts, getUserPosts, likeUnlikePost, repostPost } from "../controllers/post.controllers.js"
...
router.route("/repost/:id").post(protectedRoute, repostPost)
